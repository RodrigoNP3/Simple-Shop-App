...
class Products with ChangeNotifier {
  ...
  Future<void> FetchAndSetProduct([bool filterByUser = false]) async {
    ...
    var url = Uri.https('flutter-update-803e2-default-rtdb.firebaseio.com',
    ...
    try {
      ...
      url = Uri.https('flutter-update-803e2-default-rtdb.firebaseio.com',
  ...
  Future<void> addProduct(Product product) async {
    final url = Uri.https('flutter-update-803e2-default-rtdb.firebaseio.com',
